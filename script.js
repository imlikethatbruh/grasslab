...
const wheelStage = prizeWheel.closest('.wheel-stage');
const spinButtonRow = document.createElement('div');
spinButtonRow.className = 'spin-button-row';
wheelStage.after(spinButtonRow);
spinButtonRow.append(wheelButton);
